...
exports.useCart = function () {
    ...
    return {
        ...
        addToCart: function (_a) {
            var id = _a.id, product = _a.product, _b = _a.isUnique, isUnique = _b === void 0 ? false : _b;
            return dispatch(typesafe_actions_1.action(actionTypes_1.ADD_TO_CART, { id: id, product: product, isUnique: isUnique }));
        },
