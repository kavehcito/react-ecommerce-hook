...
describe('cart reducer', function () {
    ...
    it('should add item to cart', function () {
        ...
        expect(reducer_1.cartReducer(reducer_1.initialState, createdAction)).toEqual(__assign(__assign({}, reducer_1.initialState), { addedIds: [1], products: { objectID: 'abc' }, quantityById: { 1: 1 } }));
    });
    it('should add non-unique item to cart twice', function () {
        ...
        expect(reducer_1.cartReducer({
            ...
            quantityById: { 1: 1 },
        }, createdAction)).toEqual(__assign(__assign({}, reducer_1.initialState), { addedIds: [1], products: [{ objectID: 'abc' }], quantityById: { 1: 2 } }));
    });
    ...
    it('should remove item from cart', function () {
        ...
        expect(reducer_1.cartReducer(state, createAction(false))).toEqual(__assign(__assign({}, reducer_1.initialState), { addedIds: [], products: [], quantityById: {} }));
    });
    it('should increase items quantity, then decrease it', function () {
        ...
        expect(reducer_1.cartReducer(state, createAction(false))).toEqual(__assign(__assign({}, reducer_1.initialState), { addedIds: [1], products: [{ objectID: 'abc' }], quantityById: { 1: 1 } }));
    });
});
